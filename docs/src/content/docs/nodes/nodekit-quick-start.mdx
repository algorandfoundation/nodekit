...
import nodekitScriptInstall from '@images/nodekit.script.gif';
import nodekitBootstrapInstall from '@images/nodekit.bootstrap.install.png';
import nodekitBootstrapCatchup from '@images/nodekit.bootstrap.catchup.png';
import nodekitBootstrap from '@images/nodekit-bootstrap.png';
import nodekitFastCatchup from '@images/nodekit.catchup.png';
...
import nodekitPartKeyGen1 from '@images/nodekit.create.address.png';
import nodekitPartKeyGen2 from '@images/nodekit.create.duration.png';
...
<Image src={nodekitScriptInstall} alt='Animation of a typical NodeKit installation process' />
...
<Image src={nodekitBootstrapInstall} alt='Screenshot of a typical NodeKit installation process' />

---

It will then ask if you want to perform a "fast-catchup" with the network:

<Image src={nodekitBootstrapCatchup} alt='Screenshot of a typical NodeKit installation process' />
